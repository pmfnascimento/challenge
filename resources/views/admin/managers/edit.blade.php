    ...
    <div class="col-5">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.managers.update', ['manager' => $manager->id]) }}" method="post" class="form-horizontal">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="name" name="name" placeholder="Insert the name of manage" type="text" class="form-control @error('name') is-invalid @enderror" aria-describedby="nameHelpBlock" value="{{ $manager->name }}">
                            @error('name')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="email" name="email" type="email" class="form-control @error('email') is-invalid @enderror" value="{{ $manager->email }}" placeholder="Insert the email of manager">
                            @error('email')
                            <span class="form-text text-danger">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="form-group row">
                        <div class="offset-3 col-4">
                            <a href="{{ route('admin.managers.index') }}" class="btn btn-danger btn-block">Cancelar</a>
                        </div>
                        <div class="col-4">
