...
<head>
    ...
    <title>Admin Challenge - Administration</title>
...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark shadow-sm p-2">
        <a class="navbar-brand" href="{{ route('admin.home') }}">Admin Challenge</a>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link collapsed" href="{{ route('admin.managers.index') }}">
