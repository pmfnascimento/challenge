...
<div class="row justify-content-center">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input id="name" name="name" placeholder="Insert the name of driver" type="text" class="form-control" aria-describedby="nameHelpBlock" v-model="form.name" />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input id="email" name="email" type="email" class="form-control" placeholder="Insert the email of driver" v-model="form.email" />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-5">
                        <input id="latitude" name="latitude" type="text" placeholder="Latitude" class="form-control" v-model="form.latitude" />
                        <span class="invalid-feedback d-inline" role="alert" v-if="this.errors.latitude">
                            <strong>{{ this.errors.latitude[0] }}</strong>
                        </span>
                    </div>
                    <div class="col-5">
                        <input id="longitude" name="longitude" type="text" placeholder="Longitude" class="form-control" v-model="form.longitude" />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input id="password" name="password" type="password" class="form-control" aria-describedby="passwordHelpBlock" v-model="form.password" />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-5">
                        <button name="submit" @click.prevent="submitForm" class="btn btn-success btn-block">
                            Save
                        </button>
                    </div>
                </div>
    ...
    <div class="col-6">
        <div class="card mb-4">
            <div class="card-header">
                <i class="far fa-arrow-alt-circle-up"></i>
                <strong>Define Location Map Driver (Drag the marker to choose
                    coordinates)</strong>
            </div>
            <div class="card-body">
