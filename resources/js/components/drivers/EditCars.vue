                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input id="brand" name="brand" placeholder="Insert the brand of car" type="text"
                                    class="form-control" v-model="form.brand">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input id="model" name="model" type="text"
                                    class="form-control"
                                    placeholder="Insert the model of car" v-model="form.model">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input id="plate_number" name="plate_number" type="text"
                                    class="form-control"
                                    placeholder="Insert the plate number of car" v-model="form.plate_number">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-4">
                                <input id="latitude" name="latitude" type="text" placeholder="Latitude"
                                    class="form-control" ref="latitude" v-model="form.latitude">
                            ...
                            <div class="col-4">
                                <input id="longitude" name="longitude" type="text" placeholder="Longitude"
                                    class="form-control" ref="longitude" v-model="form.longitude">
